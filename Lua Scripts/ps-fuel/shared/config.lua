...
Config.defaultGasPrice = 11.00
Config.defaultGasStock = 500
Config.GasStationOwner = {						-- Those coords are the center of the gas pumps area (x,y,z,radius), so the script can know which gas pump is from which gas station
...
Config.canCost = 3000 -- buy jerry can price
Config.refuelCost = 600 -- refueling jerry can price
Config.GlobalTax = 5.0
