    ...
    onEnter = function ()
        if Config.InteractionType == "target" then
            ...
            target:AddCircleZone("CokeElectricMenu", Config.Coke.Electricity.coords,
                ...
                { options = {
                    { event = "bayview_drugs:coke:progress", icon = "fas fa-car-battery", label = locale("turnonelt"),
                        menu = "ElectricON" },
                    { event = "bayview_drugs:coke:progress", icon = "fas fa-car-battery", label = locale("turnoffelt"),
                        menu = "ElectricOFF" }
                },
                    distance = 2.5
                }
            ...
            target:AddCircleZone("CokeProcessMenu", Config.Coke.LeafProcess.coords,
                ...
                { options = {
                    { event = "bayview_drugs:coke:menus", icon = "fas fa-box-open", label = locale("CokeProcess"),
                        menu = "CokeProcess",
            ...
            --    { options = {
            --        { event = "bayview_drugs:coke:progress", icon = "fas fa-door-open", label = locale("leave"),
            --            menu = "CokeDoor2" }
            --    },
            --        distance = 2.5
            --    }
            ...
            target:AddCircleZone("CokeBoxMenu", Config.Coke.CokeBox.coords, Config.Coke.CokeBox.radius,
                ...
                { options = {
                    { event = "bayview_drugs:coke:menus", icon = "fas fa-box-open", label = locale("CokeBox"),
                        menu = "CokeBox",
                        canInteract = function()
                            if Electricity then
                                return true
            ...
            target:AddCircleZone("CokeFigureMenu", Config.Coke.FigurePackage.coords,
                ...
                { options = {
                    { event = "bayview_drugs:coke:menus", icon = "fas fa-box", label = locale("CokePack"),
                        menu = "CokeFigure",
                        canInteract = function()
                            if Electricity then
                                return true
            ...
            for k, v in pairs(Config.Coke.SodaTables) do
                target:AddCircleZone("CokeSodaMenu" .. k, v.coords, v.radius,
                    ...
                    { options = {
                        { event = "bayview_drugs:coke:menus", icon = "fas fa-prescription-bottle",
            ...
            cokelabzones[#cokelabzones+1] = lib.zones.sphere({
                ...
                inside = function(self)
                    if IsControlJustReleased(0, 38) then
                        TriggerEvent("bayview_drugs:coke:progress", Electricity and {menu = "ElectricOFF"} or {menu = "ElectricON"})
                    end
            ...
            cokelabzones[#cokelabzones+1] = lib.zones.sphere({
                ...
                inside = function(self)
                    if Electricity then
                        if IsControlJustReleased(0, 38) then
                            TriggerEvent("bayview_drugs:coke:menus", {menu = "CokeProcess"})
                        end
            ...
            cokelabzones[#cokelabzones+1] = lib.zones.sphere({
                ...
                inside = function(self)
                    if IsControlJustReleased(0, 38) then
                        TriggerEvent("bayview_drugs:coke:progress", {menu = "CokeDoor2"})
                    end
            ...
            cokelabzones[#cokelabzones+1] = lib.zones.sphere({
                ...
                inside = function(self)
                    if Electricity then
                        if IsControlJustReleased(0, 38) then
                            TriggerEvent("bayview_drugs:coke:menus", {menu = "CokeBox"})
                        end
            ...
            cokelabzones[#cokelabzones+1] = lib.zones.sphere({
                ...
                inside = function(self)
                    if Electricity then
                        if IsControlJustReleased(0, 38) then
                            TriggerEvent("bayview_drugs:coke:menus", {menu = "CokeFigure"})
                        end
            ...
            for k, v in pairs(Config.Coke.SodaTables) do
                cokelabzones[#cokelabzones+1] = lib.zones.sphere({
                    ...
                    inside = function(self)
                        if Electricity then
                            if IsControlJustReleased(0, 38) then
                                TriggerEvent("bayview_drugs:coke:menus", {menu = "CokeSoda", headingtotable = v.headingtotable})
                            end
...
RegisterNetEvent("bayview_drugs:coke:menus", function(data)
        ...
        if Config.Context == "qbcore" then
            exports['qb-menu']:openMenu({
                ...
                },
                {
                    ...
                    txt = '',
                    params = {
                        event = 'bayview_drugs:coke:progress',
...
-- PROGRESSY --
RegisterNetEvent("bayview_drugs:coke:progress")
AddEventHandler("bayview_drugs:coke:progress", function(data)
    --[[
    ...
    if data.menu == "CokeBox" then
        lib.callback('bayview_drugs:coke:getitem', false, function(value)
            if value then
                if not IsProgressBarActive() then
                    ...
                    local netScene = NetworkCreateSynchronisedScene(x - 0.30, y + 0.55, z - 0.65, targetRotation, 2, false
                    ...
                    TSE("bayview_drugs:coke:giveitems", data.menu)
    ...
    elseif data.menu == "EmptyFigure" then
        if data.option == "break" then
            ...
            TSE("bayview_drugs:coke:giveitems", "empty")
        else
    ...
    elseif data.menu == "FullFigure" then
        if data.option == "break" then
            ...
            TSE("bayview_drugs:coke:giveitems", data.option)
        else
            if not FigureCarry then
                local ped = cache.ped
                RequestAnimDict("impexp_int-0")
        ...
        lib.callback('bayview_drugs:coke:getitem', false, function(value)
            if value then
                if not IsProgressBarActive() then
                    ...
                    FreezeEntityPosition(cache.ped, true)
                    ProgressBar(6000, locale("CokeProcessing"))
                    DetachEntity(prop, false, false)
                    DeleteEntity(prop)
                    StopAnimTask(cache.ped, dict, clip, 1.0)
                    Wait(0)
        ...
        lib.callback('bayview_drugs:coke:getitem', false, function(value)
            if value then
                if not IsProgressBarActive() then
                    ...
                    SetEntityCoords(ped, Config.Coke.SodaTables[1].teleport, false, false, false, true)
                    Wait(150)
                    ...
                    if headingtotable == 0.0 then
                        ...
                        netScene = NetworkCreateSynchronisedScene(x + 1.58, y - 1.30, z - 0.65, targetRotation, 2, false,
                            false, 1148846080, 0, 1.1)
                    end
                    --vector3(-277.88, -2668.99, 6.45) normal
                    --vector3(-281.46, -2668.57, 6.46)
        ...
        lib.callback('bayview_drugs:coke:getitem', false, function(value)
            if value then
                if not IsProgressBarActive() then
                    ...
                    TSE('bayview_drugs:deleteprop', ObjToNet(target))
                    SetEntityAsMissionEntity(target, false, true)
                    DeleteObject(target)
                    table.remove(CokePlants, nearbyID)
                    SpawnedCokePlant = SpawnedCokePlant - 1
                    TSE('bayview_drugs:coke:giveitems', "CokePick")
                end
            else
    ...
    if Config.Coke.Enterlab.NeedItem then
        if Config.InteractionType ~= "target" then
            lib.zones.sphere({
                ...
                inside = function(self)
                    if IsControlJustReleased(0, 38) then
                        TriggerEvent("bayview_drugs:coke:progress", {menu = "CokeDoor1", Card = Config.Coke.Enterlab.ItemName})
                    end
        ...
        if Config.InteractionType ~= "target" then
            lib.zones.sphere({
                ...
                inside = function(self)
                    if IsControlJustReleased(0, 38) then
                        TriggerEvent("bayview_drugs:coke:progress", {menu = "CokeDoor1"})
                    end
